...
public class Quiz4Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionList = QuestionData.getQuestions6();
        tvOptionOne = findViewById(R.id.tv_option_one4);
        tvOptionTwo = findViewById(R.id.tv_option_two4);
        tvOptionThree = findViewById(R.id.tv_option_three4);
        btnSubmit = findViewById(R.id.btn_submit4);
        tvProgress = findViewById(R.id.tv_progress4);
        tvQuestion = findViewById(R.id.tv_question4);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.tv_option_one4){
            selectedOptionView(tvOptionOne,1);
        }
        else if (v.getId() == R.id.tv_option_two4) {
            selectedOptionView(tvOptionTwo,2);
        }
        else if (v.getId() == R.id.tv_option_three4) {
            selectedOptionView(tvOptionThree,3);
        }
        else if (v.getId() == R.id.btn_submit4){
            if (selectedOption == 0){
                currentPosition++;
                if (currentPosition <= questionList.size()) {
                    setQuestion();
                } else {
                    Intent intent = new Intent(Quiz4Activity.this, ResultActivity.class);
    ...
    private void selectedOptionView(TextView tv, int selecteOptionNum) {
        ...
        tv.setBackground(ContextCompat.getDrawable(Quiz4Activity.this,R.drawable.selected_option));
    ...
    private void defaultOptionView() {
        ...
        for (int i = 0;i < options.size();i++){
            ...
            option.setBackground(ContextCompat.getDrawable(Quiz4Activity.this,R.drawable.default_option_border_bg));
        }
    }

    private void answersView(int answers, int drawableView) {
        if (answers == 1) {
            tvOptionOne.setBackground(ContextCompat.getDrawable(Quiz4Activity.this,drawableView));
        } else if (answers == 2) {
            tvOptionTwo.setBackground(ContextCompat.getDrawable(Quiz4Activity.this,drawableView));
        } else if (answers == 3) {
            tvOptionThree.setBackground(ContextCompat.getDrawable(Quiz4Activity.this,drawableView));
        }
    }
}