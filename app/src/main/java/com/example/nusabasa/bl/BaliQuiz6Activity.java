...
import com.example.nusabasa.jv.FillTextQuestion;
import com.example.nusabasa.jv.FillTextQuestionData;
import com.example.nusabasa.jv.QuestionData;
import com.example.nusabasa.jv.Quiz6Activity;

import java.util.ArrayList;

public class BaliQuiz6Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bali_quiz6);
        ...
        if (v.getId() == R.id.btn_submit_bali6) {
            if (answer.toString().isEmpty()){
                ...
                if (currentPosition <= questionList.size()) {
                    ...
                    Intent intent = new Intent(BaliQuiz6Activity.this, ResultActivity.class);
    ...
    private void answersView( int drawableView) {
        editText.setBackground(ContextCompat.getDrawable(BaliQuiz6Activity.this,drawableView));
    }
}